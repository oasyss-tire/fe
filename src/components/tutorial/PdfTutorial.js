...
const ImageCarousel = ({ images }) => {
  ...
  // images prop이 변경될 때 activeImage를 0으로 초기화
  useEffect(() => {
    setActiveImage(0);
  }, [images]);
...
// 튜토리얼 스텝 데이터 (PDF 변환 관련 튜토리얼)
const tutorialSteps = [
  {
    label: 'PDF 변환 및 저장',
    description: '점검 결과 페이지 제일 하단에 \n \'PDF 다운로드\' 버튼을 클릭하여 \n 작성된 리포트를 PDF 파일로 변환합니다.',
    images: [
      '/images/pdf-1.png',
    ],
  },
  {
    label: 'PDF 확인',
    description: '저장된 PDF 파일을 한눈에 확인할 수 있습니다.',
    images: [
      '/images/pdf-2.png',
    ],
  },
